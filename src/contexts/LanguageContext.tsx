...
const translations = {
  de: {
    ...
    earlyBirdNormalDesc: 'Beide Ticket-Typen sind als Early Bird oder Normal Bird erhältlich, abhängig davon, wann du dein Ticket kaufst / Verfügbarkeit (Es wird eine begrenzte Anzahl von Early-Bird-Tickets geben).',
    ...
    normalTotalLimitDesc: 'Setze die Gesamtanzahl verfügbarer Normal Bird Tickets für alle Rollen. Leer lassen für unbegrenzt. Normal Bird Tickets werden automatisch nicht mehr verfügbar, wenn dieses Limit erreicht ist.',
  ...
  en: {
    ...
    earlyBirdNormalTitle: 'Early Bird / Normal Bird',
    earlyBirdNormalDesc: 'Both ticket types are available in Early Bird or Normal Bird varieties depending on when you purchase your ticket / availability (There will be a limited amount of Early-Bird Tickets available).',
    ...
    standardTicketType: 'Standard Tickets',
    standardTicketTypeDesc: 'Standard Tickets include taking over one 2-hour shift during the festival. You can choose between Early Bird and Normal Bird options depending on availability.',
