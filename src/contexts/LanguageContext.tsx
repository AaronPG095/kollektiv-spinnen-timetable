...
const translations = {
  de: {
    ...
    ticketTypesNote: 'Hinweis: Aufgrund der inhärenten Non-Profit / Community-basierten Natur von Kollektiv Spinnen beinhalten alle Soli-Beiträge für unser Festival die Übernahme einer Schicht in einer der verschiedenen Rollen, die benötigt werden, um all dies möglich zu machen. Die Länge der Schichten variiert zwischen Standard-Soli-Beiträgen & Reduzierten Soli-Beiträgen.',
    ...
    standardTicketTypeDesc: 'Standard Tickets beinhalten die Übernahme einer 2-Stunden-Schicht während des Festivals. Du kannst zwischen Early Bird und Normal Bird Optionen wählen, abhängig von der Verfügbarkeit.',
  ...
  en: {
    ...
    ticketTypesNote: 'Note: Due to the inherent non-profit / community based nature of Kollektiv Spinnen, all Soli-Contributions for our festival include taking over a shift in one of the various roles needed to make all of this happen. Lengths of shifts vary between Standard Soli-Contributions & Reduced Soli-Contributions.',
    earlyBirdNormalTitle: 'Early Bird / Normal Bird',
    ...
    reducedTicketTypeDesc: 'Reduced Soli-Contributions offer a price discount due to the intensity or additional responsibility of the related positions. These contributions are available for special roles such as Setup, Breakdown, Awareness, or Shift Management.',
