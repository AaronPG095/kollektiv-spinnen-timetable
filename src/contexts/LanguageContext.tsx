...
const translations = {
  de: {
    ...
    checklistItem3: 'Leiste deinen Soli-Beitrag über den/die PayPal-Link(s) zu unserem Money Pool mit deinem Referenzcode (sehr wichtig!)',
  ...
  en: {
    ...
    payWithPayPal: 'Pay Soli-Contribution with PayPal',
    ...
    checklistItem3: 'Pay your Soli-Contribution over the PayPal Link(s) to our Money Pool using your Reference Code (Very Important!)',
    ...
    paypalPaymentInstructions: 'Please pay the Soli-Contribution amount of {amount}€ via PayPal before submitting the form.',
