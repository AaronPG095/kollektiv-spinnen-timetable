...
const translations = {
  de: {
    ...
    paymentConfirmed: 'ÜBERWEISUNG BESTÄTIGEN',
    ...
    pleaseFollowChecklist: 'Bitte folge der Checkliste oben, um sicherzustellen, dass der Bestätigungsprozess korrekt abläuft, und stelle sicher, dass du deine Überweisung am Ende der Seite bestätigst. Nur dann ist deine Buchung gültig.',
    ...
    onlyClickAfterPayment: 'Klicke nur auf den Button "ÜBERWEISUNG BESTÄTIGEN", nachdem du deinen Soli-Beitrag über PayPal überwiesen hast und die Checkliste oben abgeschlossen hast',
  ...
  en: {
    ...
    paymentConfirmed: 'CONFIRM TRANSFER',
    ...
    checklist: 'Checklist',
    pleaseFollowChecklist: 'Please follow the checklist above to ensure the confirmation process goes through correctly, and ensure you confirm your transfer at the bottom of the page. Only then will your booking be valid.',
    ...
    onlyClickAfterPayment: 'Only click the confirm transfer button after transferring your Soli-Contribution over PayPal, and completing the checklist above.',
